package com.fernirsmodz.fernirsarmors;

import com.fernirsmodz.fernirsarmors.block.ModBlocks;
...
@Mod(FernirsArmors.MOD_ID)
public class FernirsArmors
{
    public static final String MOD_ID = "fernirsarmors";
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();

    public FernirsArmors() {
